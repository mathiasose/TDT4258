...
Using the eAProfiler monitoring tool we observed the board idling at about $2.0 \mu A$ while running the final iteration of the program with sleep mode enabled. When running the build with polling instead of interrupts, the amperage was around $3.6 mA$.
